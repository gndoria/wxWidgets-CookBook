...
MainFrame::MainFrame(const wxString &title)
	...
	gridSizer = new wxGridSizer(3, 5 ,5);/**Initialise a grid sizer with three colimns*/
	/**Sizers can be nested*/
	contentSizer->Add(gridSizer, 1, wxEXPAND, 5);/**Add the gridSizer to contentSizer and make it occupy the whole screen.Try resizing the frame to
	see what happens*/
	...
	/**Add the buttons to the gridSizer*/
