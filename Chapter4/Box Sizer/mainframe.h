...
class MainFrame : public wxFrame{
	...
	private:
		...
		wxSizer *mainSizer, *contentSizer;/**Declare a generic sizer.This is to allow you to specialise it to a diffrent sizer type as required.
		...
		wxPanel *mainPanel;/**The panel will be added to the mainSizer.This is to cover the window background in microsoft windows*/
